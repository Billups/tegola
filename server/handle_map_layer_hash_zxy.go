...
type HandleMapLayerHashZXY struct {
	// required
	mapName string
	// optional
	layerName string
...
func (req *HandleMapLayerHashZXY) parseURI(r *http.Request) error {
	var err error
...
// 	x - row
// 	y - column
func (req HandleMapLayerHashZXY) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	// parse our URI
